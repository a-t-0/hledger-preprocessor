...
class Test_script_with_multiline_args(unittest.TestCase):
    ...
    def test_multiline_args_and_dirs(self):
        ...
        expected_file_path = f"{self.existent_tmp_dir}/import/{account_holder}/{bank_name}/{account_type}"
        print(f"expected_file_path={expected_file_path}")
...
def generate_random_csv() -> str:
    ...
    file_path = random_dir / random_filename
